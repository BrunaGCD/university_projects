...
=-=-= MUDANÇAS FORAM FEITAS NA CLASSE PARA SUPORTAR PESOS =-=-=
*Onde uma mudança foi feita, terá um comentário "MUDANÇA" do lado
...
public class TGrafo{
	...
	public TNo adj[]; // MUDANÇA: AGORA É PUBLIC | um vetor onde cada entrada guarda o inicio de uma lista
	// métodos públicos
	...
	*/
	public void insereA( int v, int w, int peso) { // MUDANÇA
